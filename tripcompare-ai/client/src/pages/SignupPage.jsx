  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-80px)] w-full max-w-md items-center px-5 py-8">
      <section className="glass-card w-full rounded-3xl p-6 shadow-soft">
        <h1 className="font-display text-3xl text-slate-700">Create account</h1>
        <p className="mt-1 text-sm text-slate-600">Start planning trips with transparent cost breakdowns.</p>
        ...
        <p className="mt-4 text-sm text-slate-600">
          Already have an account? <Link className="font-semibold text-sky-600" to="/login">Login</Link>
        </p>
      </section>
    </main>
  );
